...
{% raw %}<p><center><a href="/assets/images/2025-07-16-portmaster-password-recovery-wasm/portmaster-01-sm-d.png"><img style="width: 80% max-width: 720px; display: block; margin: 0 auto; border 0" src="/assets/images/2025-07-16-portmaster-password-recovery-wasm/portmaster-01.jpeg" alt="A Portmaster 2e and a Portmaster 3" onmouseover="this.src='./assets/images/2025-07-16-portmaster-password-recovery-wasm/portmaster-01-sm.jpg';" onmouseout="this.src='./assets/images/2025-07-16-portmaster-password-recovery-wasm/portmaster-01-sm-d.png';"></a><figcaption>A Portmaster 2e and a Portmaster 3.</figcaption></center></p>{% endraw %}
